...
export const authApi = {
  ...
  updateProfile: async (id: number, data: { name?: string; email?: string; phone?: string; city?: string; birthDate?: string | null; latitude?: number; longitude?: number }): Promise<User> => {
